...
"""
class SSHConnection:
    Class handling the SSH cnnection between the server and the vehicles
    def __init__(self, IP_ADRESS, USERNAME, PASSWORD):
        # connection data
    ...
    def establish_connection(self):
        ...
        self.connection.connect(self.IP_ADRESS, username=self.USERNAME, password=self.PASSWORD)
...
class Fleet:
    ...
    def keyboard_remote(self):
        ...
        # init controller
        controller=VehicleController([car.ID for car in self.cars])
